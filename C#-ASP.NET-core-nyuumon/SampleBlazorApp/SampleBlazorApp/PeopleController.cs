...
namespace SampleBlazorApp
{
    ...
    {
        private readonly SampleBlazorAppContext _context;

        public PeopleController(SampleBlazorAppContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Person != null ? 
                          ...
                          Problem("Entity set 'SampleBlazorAppContext.Person'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'SampleBlazorAppContext.Person'  is null.");
            }
            var person = await _context.Person.FindAsync(id);
            if (person != null)
            {
